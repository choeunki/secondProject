/*ⓒ 2016.1 Eunki All Rights Reserved 모든 저작권은 저작자인 조은기에게 있습니다.*/
...
public class background extends JFrame implements KeyListener, ActionListener {
	...
	static Mygame mg; //실제 게임 진행 화면 클래스 선언
	...
	public void actionPerformed(ActionEvent e) {
		...
		//전달 받은 MenuItem 매개변수가 '다시시작'일 경우
 		...
 		//전달 받은 MenuItem 매개변수가 '조작방법'일 경우
		else if(e.getSource() == mnKey) { 
			h.setVisible(true);
		}
 		//전달 받은 MenuItem 매개변수가 '만든이'일 경우
